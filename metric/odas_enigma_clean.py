...
if __name__ == "__main__":
    ...
    csv_filename = "test_csv/test_ht_hr.csv"
    filename_predictions = "eval_results/enigma_ht_hr/clean-pond-51.pkl"
    
    dataset_classes = HT_HR_FC_HD
    csv_filename = "test_csv/test_ht_hr_fc_hd.csv"
    filename_predictions = "eval_results/enigma_ht_hr_fc_hd/youthful-breeze-61.pkl"

    dataset_classes = FC_HD
    csv_filename = "test_csv/test_fc_hd.csv"
    filename_predictions = "eval_results/enigma_fc_hd/comfy-feather-63.pkl"
